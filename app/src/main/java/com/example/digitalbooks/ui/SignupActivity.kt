...
class SignupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        signup_activity_createAccountBtn.setOnClickListener {
            ...
            val confirmPassword = signup_activity_confirmpassword.text.toString()
            ...
            when{
                ...
                password != confirmPassword -> Toasty.info(this,"Password did not match",Toasty.LENGTH_LONG).show()
